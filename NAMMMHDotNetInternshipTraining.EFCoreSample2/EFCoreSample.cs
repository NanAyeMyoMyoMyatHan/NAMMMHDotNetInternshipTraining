...
namespace NAMMMHDotNetInternshipTraining.EFCoreSample2;
...
public class EFCoreSample
{
    ...
    {
        List<TblStudent> students = _context.TblStudents.ToList();
    ...
    {
        var student = _context.TblStudents.FirstOrDefault(s => s.StudentId == 1);
        if (student != null)
        {
